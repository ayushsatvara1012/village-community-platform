...
const History = () => {
    ...
    const chapters = [
        ...
        },
        {
            ...
            quote: "We don't just build temples; we strive to make our lives a living shrine to the truth.",
